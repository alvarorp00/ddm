...
/**
 * This is the item provider adapter for a {@link wizards.TextField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextFieldItemProvider extends ComponentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextField_input_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextField_input_feature", "_UI_TextField_type"),
				 WizardsPackage.Literals.TEXT_FIELD__INPUT,
				 true,
				 false,
				 false,
	...
	protected void addMin_lengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextField_min_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextField_min_length_feature", "_UI_TextField_type"),
				 WizardsPackage.Literals.TEXT_FIELD__MIN_LENGTH,
				 true,
				 false,
				 false,
	...
	protected void addMax_lengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextField_max_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextField_max_length_feature", "_UI_TextField_type"),
				 WizardsPackage.Literals.TEXT_FIELD__MAX_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((TextField)object).getLabel();
