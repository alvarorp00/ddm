...
/**
 * This is the item provider adapter for a {@link wizards.CheckBox} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CheckBoxItemProvider extends ComponentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WizardsPackage.Literals.CHECK_BOX__SELECTED,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((CheckBox)object).getLabel();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CheckBox.class)) {
			case WizardsPackage.CHECK_BOX__SELECTED:
