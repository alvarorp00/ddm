...
public class WizardsTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ NsURIPackageId PACKid_wizards = IdManager.getNsURIPackageId("wizards", null, WizardsPackage.eINSTANCE);
	public static final /*@NonInvalid*/ ClassId CLSSid_Button = WizardsTables.PACKid_wizards.getClassId("Button", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_CheckBox = WizardsTables.PACKid_wizards.getClassId("CheckBox", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Class = WizardsTables.PACKid_$metamodel$.getClassId("Class", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_CloseButton = WizardsTables.PACKid_wizards.getClassId("CloseButton", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_NavigatorButton = WizardsTables.PACKid_wizards.getClassId("NavigatorButton", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Page = WizardsTables.PACKid_wizards.getClassId("Page", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_PopUpButton = WizardsTables.PACKid_wizards.getClassId("PopUpButton", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_ReturnButton = WizardsTables.PACKid_wizards.getClassId("ReturnButton", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_TextField = WizardsTables.PACKid_wizards.getClassId("TextField", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Wizard = WizardsTables.PACKid_wizards.getClassId("Wizard", 0);
