...
public class NavigatorButtonImpl extends ButtonImpl implements NavigatorButton {
	...
	public Page targetPage() {
		...
		if (not == ValueUtil.FALSE_VALUE) {
			...
			try {
				...
				if (checkBox_0 == null) {
					throw new InvalidValueException("Null source for \'\'wizards\'::CheckBox::selected\'");
				}
	 ...
	 */
	public void action() {
		throw new UnsupportedOperationException();  // FIXME Unimplemented wizards!NavigatorButton!action()
	}
