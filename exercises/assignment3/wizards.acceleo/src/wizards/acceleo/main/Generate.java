...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/wizards/acceleo/main/generate";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generateWizard" };
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if(!isInWorkspace(WizardsPackage.class))
        	resourceSet.getPackageRegistry().put(WizardsPackage.eNS_URI,
        			WizardsPackage.eINSTANCE);
    }
