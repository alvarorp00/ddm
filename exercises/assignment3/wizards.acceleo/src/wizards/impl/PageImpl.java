...
public class PageImpl extends MinimalEObjectImpl.Container implements Page {
	 ...
	 */
	public void action() {
		throw new UnsupportedOperationException();  // FIXME Unimplemented /ejemplo/metamodel/wizards.ecore!Page!action()
	}
	 ...
	 */
	public void show() {
		throw new UnsupportedOperationException();  // FIXME Unimplemented /ejemplo/metamodel/wizards.ecore!Page!show()
	}
	 ...
	 */
	public void close() {
		throw new UnsupportedOperationException();  // FIXME Unimplemented /ejemplo/metamodel/wizards.ecore!Page!close()
	}
						...
						public /*@Nullable*/ Object evaluate(final Executor executor, final TypeId typeId, final /*@Nullable*/ Object /*@NonNull*/ [] sourceAndArgumentValues) {
							...
							try {
								...
								if (!ne) {
									...
									try {
										if (local_0 == null) {
											throw new InvalidValueException("Null source for \'\'/ejemplo/metamodel/wizards.ecore\'::Component::label\'");
										}
