...
public interface OrdersPackage extends EPackage {
	...
	/**
	 * The operation id for the '<em>Non Duplicate Items</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PURCHASE_ORDER___NON_DUPLICATE_ITEMS__DIAGNOSTICCHAIN_MAP = 0;
	 ...
	 * @ordered
	 */
	int PURCHASE_ORDER_OPERATION_COUNT = 1;
	 ...
	 * @ordered
	 */
	int ITEM___POSITIVE_PRICE__DIAGNOSTICCHAIN_MAP = 0;
	...
	/**
	 * Returns the meta object for the '{@link orders.PurchaseOrder#nonDuplicateItems(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Non Duplicate Items</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Non Duplicate Items</em>' operation.
	 * @see orders.PurchaseOrder#nonDuplicateItems(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getPurchaseOrder__NonDuplicateItems__DiagnosticChain_Map();
	...
	/**
	 * Returns the meta object for the '{@link orders.Item#positivePrice(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Positive Price</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Positive Price</em>' operation.
	 * @see orders.Item#positivePrice(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Non Duplicate Items</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PURCHASE_ORDER___NON_DUPLICATE_ITEMS__DIAGNOSTICCHAIN_MAP = eINSTANCE.getPurchaseOrder__NonDuplicateItems__DiagnosticChain_Map();
